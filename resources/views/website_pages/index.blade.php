            ...
            <div class="row">
                <div class="col-lg-6 slider__content-con mb-0">
                    ...
                    <div class="def-con {{ session('mood')=='{dark}'?'dark':'light' }}-color-p change-color-p" style="margin-bottom: 7rem;">
                        A group specialized in providing the best forex services in the Arab world, educational courses, free recommendations, free strategies and indicators, and analyzes
                    </div>
...
<div class="{{ session('mood')=='{dark}'?'dark':'light' }}-mood why-we change" id="services">
    <div class="title">
        <h1 class="{{ session('mood')=='{dark}'?'dark':'light' }}-color-h change-color-h">Lets show what pro traders provide for you </h1>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                    <div class="card card-x p-4">
                        <img src="{{ asset('website_folder/imag/main_picture_fonders4-01.svg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                    <div class="card card-x p-4 text-center">
                        <img src="{{ asset('website_folder/imag/main_picture_fonders_details4-01.svg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                    <div class="card card-x p-4 text-center">
                        <img src="{{ asset('website_folder/imag/developers-white2-01.svg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                    <div class="card card-x p-4 text-center">
                        <img src="{{ asset('website_folder/imag/presentation.png') }}" alt="" class="w-100">
                ...
                <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                    <div class="card card-x p-4 text-center">
                        <img src="{{ asset('website_folder/imag/mob.png') }}" alt="" class="w-100">
                        <h1>Learn Forex</h1>
                        <p class="pl-3">
                            the service providers healthcare companies and the market in general over the social media platforms Based on our last work experience in medical insurance field.
                        </p>
...
<div class="courses" style="margin-top: 15rem;" id="vedios">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="{{ asset('website_folder/imag/forex.mp4') }}"></iframe>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="vedio-sub {{ session('mood')=='{dark}'?'dark':'light' }}-color-p change-color-p">
                    For the first time in the Arab world, trading will take place Liquidity can enter strong and directional deals Right market with high success rate ↖️👌 <br>
                    <div class="mt-3">
                        ♻️ Site Features :-
                    </div>
                    <div class="pl-2 mt-3">
                        ✅ The site tells you the liquidity of currency pairs, whether buying or selling, stronger and weaker currency in real time and with accurate digital analysis <br> ✅ 24 hours support ⏰ <br> ✅ Through all this, your deals enter
